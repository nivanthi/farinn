...
<div class="row">
   <div class="col-md-12">
      <form id="validate" role="form" class="form-horizontal" method="post" accept-charset="utf-8" action="<?php echo base_url();?>index.php/report/meal_report" target="_blank">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group showHide foodC" id="showHide">
                              <label class="control-label col-md-3">Food Code:</label>
                              <div class="col-md-8">
                           ...
                           <div class="form-group showHide beverageC"  id="showHide">
                              <label class="control-label col-md-3">Beverage Code:</label>
                              <div class="col-md-8">
                            ...
                            <div class="form-group showHide beverageName"  id="showHide">
                              <label class="col-md-3 control-label">Beverage Name:</label>
                              <div class="col-md-8">
                        ...
                        <div class="panel-footer" >            
                           ...
                           <input style="margin-left:12%" type="submit" class="btn  btn-primary " value=" View Report">                          
                        </div>
                     </div>
                  </div>
               </div>
...
<script type="text/javascript">//hide many dives at once using same class name
