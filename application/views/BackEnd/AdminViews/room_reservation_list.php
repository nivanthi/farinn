            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table datatable">
                  ...
                  <a class='btn btn-default btn-rounded btn-condensed btn-sm' href="<?php echo base_url(); ?>/index.php/backend_controller/edit_room_reservation/<?php echo $id; ?>"><i class="fas fa-pencil-alt"></i></a>
