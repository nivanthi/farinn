  ...
  <ul class="x-navigation">
    ...
    <li class="xn-profile"> <a href="#" class="profile-mini"> <img src="<?php echo base_url(); ?>assets/BackEnd/images/users/<?php echo  $_SESSION['picture'] ?>" /> </a>
      <div class="profile">
        ...
        <div class="profile-controls"> <a href="<?php echo base_url();?>index.php/backend_controller/f_load_profile" class="profile-control-left"><span class="fa fa-info"></span></a> </div>
      </div>
    </li>
    <center>
    ...
    <li class="  xn-openable <?php  if($this->uri->segment(1)==" banquet "){ echo 'class = "active " ';} ?>  "> <a href="#"><span class="glyphicon glyphicon-home"></span> <span class="xn-text"> Room Reservation</span></a>
      <ul>
        <li><a href="<?=base_url('index.php/backend_controller/f_add_room_reservaion_details');?>"><i class="far fa-circle"></i> Add Room Reservation</a> </li>
        <li><a href="<?=base_url('index.php/backend_controller/f_reserved_room_list');?>"><i class="far fa-circle"></i> Room Reservation List</a> </li>
      </ul>
    </li>
    <li class="  xn-openable <?php  if($this->uri->segment(1)==" banquet "){ echo 'class = "active " ';} ?>  "> <a href="#"><span class="glyphicon glyphicon-home"></span> <span class="xn-text"> Banquet Reservation</span></a>
      <ul>
        <li><a href="<?=base_url('index.php/backend_controller/f_function_management_add');?>"><i class="far fa-circle"></i> Add Banquet Reservation</a> </li>
        <li><a href="<?=base_url('index.php/backend_controller/f_function_management_List');?>"><i class="far fa-circle"></i> Banquet Reservation List</a> </li>
      </ul>
    </li>
    <li class="  xn-openable <?php  if($this->uri->segment(1)==" report "){ echo 'class = "active " ';} ?>  "> <a href="#"><span class="fa fa-car"></span> <span class="xn-text"> Tour Reservation</span></a>
      <ul>
        <li> <a href="<?php echo base_url(); ?>index.php/backend_controller/f_add_tour_view"><i class="far fa-circle"></i> <span class="xn-text"> Add Tour Reservation</span></a> </li>
        <li> <a href="<?php echo base_url(); ?>index.php/backend_controller/f_tour_List"><i class="far fa-circle"></i> <span class="xn-text"> Tour Reservation List</span></a> </li>
      </ul>
    </li>
  </ul>
</div>
