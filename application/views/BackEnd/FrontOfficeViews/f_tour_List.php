								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a class='btn btn-default btn-rounded btn-condensed btn-sm' href="<?php echo base_url(); ?>/index.php/backend_controller/f_edit_tour_details/<?php echo $id; ?>"><i class="fas fa-pencil-alt"></i></a>
