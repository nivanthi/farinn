                                     ...
                                     if($list['pay_complete']==0)
                                       ...
                                       echo "<td class='text-center'>". $paid. "</td>";  
                                        ...
                                        echo " <td>"?>
                                          ...
                                          <a class='btn btn-default btn-rounded btn-condensed btn-sm' href="<?php echo base_url(); ?>/index.php/backend_controller/f_edit_banquet_reservation/<?php echo preg_replace("/[^0-9,.]/", "", $id); ?>"><i class="fas fa-pencil-alt"></i></a>
