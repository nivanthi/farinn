...
<ul class="breadcrumb">
    ...
    <li class="active">Edit Banquet Reservation</li>
</ul>
<div class="page-title">
    <h2> Edit Banquet Reservation</h2>
</div>
                    ...
                    <div class="tab-content">
                            ...
                            <form id="addBanquetRequestTab1" name="addBanquetRequestTab1" class="form-horizontal"  action="javascript:tabOneNext();">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group ">
                                                <input type="text" class=" form-control timepicker24 validate[required]" id="funcTime" name="funcTime" placeholder="Start Time (24 hrs)"/>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control validate[required]"  name="menu" id="menu" >
                                                ...
                                                if (count($menu)) {
                                                    ...
                                                    foreach ($menu as $list) {
                                                        echo "<option    value=" . $list['menu_id'] . ">" . $list['menu_no'] . "  </option>";
                                                    }
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" class="form-control validate[required, custom[integer],min[50],max[450]]" name="count" id="count" 
                                            placeholder="No of Guests" value="<?php echo $bnq[0]->guest_count; ?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6"> <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control validate[required]" name="name" value="<?php echo $bnq[0]->customer; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">E-mail</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control validate[custom[email]] " name="email" value="<?php echo $bnq[0]->email; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Contact</label>
                                        <div class="col-md-8">
                                            <input type="text" class=" form-control validate[required] phone" name="contact" id="contact" value="<?php echo $bnq[0]->contact; ?>"/>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane " id="tab-second">
                            <form id="addBanquetRequestTab2"  class="form-horizontal"  action="javascript:tabTwoNext();">
                                <div class="panel-heading" style="background-color:#33414E;">
                                    <h4 class="panel-title" style="color:white" ><span class="fa fa-user"></span><strong> &#160; Extra </strong> Facilities & <strong> Menu Item </strong> Requests</h4>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group"> <br>
                                        <br>
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><input type="checkbox" class=""  id="chkDancingGroup"/>
                                                        &#160; Dancing Group</td>
                                                ...
                                                <tr>
                                                    <td><input type="checkbox" class=""  id="chkFlowerArrengement"/>
                                                        &#160; Flower Arrengement</td>
                                                ...
                                                <tr>
                                                    <td><input type="checkbox" class=""  id="chkCakeStructure"/>
                                                        &#160; Cake Structure</td>
                                                ...
                                                <tr  bgcolor="#33414E" style="color:'white'">
                                                    ...
                                                    <td class="text-right" style="color:white;"><b> <span id="sum">0.00</span> </b></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <table id="tblMenuRequest" class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><b>
                                                        <input type="text"  class="form-control text-right menuTextBoxes" disabled name="txtMenuSubTot" id="txtMenuSubTot"/>
                                                    </b></td>
                                            </tr>
                                            <tr  bgcolor="#33414E" style="color:'white'">
                                                <td colspan="3" style="color:white;"><b> &#160; TOTAL AMOUNT (Rs.)</b></td>
                                                <td class="text-right" style="color:white;"><b> <span id="menuSum" >0.00</span> </b> </b></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="col-md-5"> <br>
                                    ...
                                    <table id="tblOtherCharge" class="table" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr  bgcolor="#33414E" style="color:'white'">
                                                <td style="color:white;"><b> &#160; TOTAL AMOUNT (Rs.)</b></td>
                                                <td class="text-right" style="color:white;"><b> <span id="txtOtherSum" >0.00</span> </b></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control text-right final ro" readonly name="txtFinalBanquetCharge" id="txtFinalBanquetCharge" /></td>
                                            </tr>
                                            <tr>
                                                <td> Extra Facility Charges </td>
                                                <td><input type="text" class="form-control text-right final ro" readonly name="txtFinalExtraCharge" id="txtFinalExtraCharge" /></td>
                                            </tr>
                                            <tr>
                                                <td> Menu Request Charge </td>
                                                <td><input type="text" class="form-control text-right final ro" readonly name="txtFinalMenuCharge" id="txtFinalMenuCharge" /></td>
                                            </tr>
                                            <tr>
                                                <td>Other Charges </td>
                                                <td><input type="text" class="form-control text-right final ro" readonly name="txtFinalOtherCharge" id="txtFinalOtherCharge"  /></td>
                                            </tr>
                                            <tr  bgcolor="#495661" style="color:'white'">
                                                <td  style="color:white;"><b>&#160; SUB TOTAL (Rs.) </b></td>
                                                <td class="text-right" style="color:white;"><b> <span id="txtFinalSubTotal" name="txtFinalSubTotal" >0.00</span> </b></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" class="grand form-control text-right ro" name="txtDiscountedAmnt" id="txtDiscountedAmnt"  readonly placeholder="Discounted Amount"/></td>
                                            </tr>
                                            <tr>
                                                <td>NBT</td>
                                                ...
                                                <td><input type="text" class="grand form-control text-right ro" name="txtnbtAmnt" id="txtnbtAmnt" readonly placeholder="NBT Amount"/></td>
                                            </tr>
                                            <tr>
                                                <td>VAT</td>
                                                ...
                                                <td><input type="text" class="grand form-control text-right ro" name="txtVatAmnt" id="txtVatAmnt" readonly placeholder="VAT Amount"/></td>
                                            </tr>
                                            <tr  bgcolor="#495661" style="color:'white'">
                                                <td  style="color:white;" colspan="2"><b>&#160; GRAND TOTAL (Rs.) </b></td>
                                                <td class="text-right" style="color:white;"><b> <span id="txtFinalGrandTotal" name="txtFinalGrandTotal" >0.00</span> </b></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><div class="form-group">
                                                        ...
                                                        <span class="help-block">Example: 2012-12-21 </span> </div></td>
                                            </tr>
                                            <tr  bgcolor="#33414E" style="color:'white'">
                                                <td  style="color:white;" colspan="2"><b>&#160; BALANCE (Rs.)</b></td>
                                                <td class="text-right" style="color:white;"><b> <span id="txtFinalBalance" name="txtFinalBalance" >0.00</span> </b></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <div class="mb-content">
                <p style="font-size:15px">Banquet Reservation data has been SUCCESSFULLY stored into the Database. </p>
            </div>
            <div class="mb-footer">
...
<script type="text/javascript">
    ...
    function saveBanquetRequest()
    {
        ...
        var otherChargeRowCount = $('#tblOtherCharge tr').length;

        var sub = document.getElementById("txtFinalSubTotal").innerHTML;

        var grand = document.getElementById("txtFinalGrandTotal").innerHTML;

        var bal = document.getElementById("txtFinalBalance").innerHTML;
        ...
        $.ajax({
            ...
            data: {tab1Data: tab1Data, tab2Data: tab2Data, tab3Data: tab3Data,
                menuRowCount: menuRowCount, otherChargeRowCount: otherChargeRowCount,
                sub: sub, grand: grand, bal: bal
            },
